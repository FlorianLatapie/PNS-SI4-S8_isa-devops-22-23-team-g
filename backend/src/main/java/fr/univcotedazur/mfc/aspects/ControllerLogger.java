package fr.univcotedazur.mfc.aspects;
...
public class ControllerLogger {
    ...
    @Pointcut("execution(public * fr.univcotedazur.mfc.components..*(..))")
    private void allComponentsMethods() {
    } // This enables to attach the pointcut to a method name we can reuse below

    @Pointcut("execution(public * fr.univcotedazur.mfc.repositories..*(..))")
    private void allRepositoriesMethods() {
    } // This enables to attach the pointcut to a method name we can reuse below

    @Pointcut("execution(public * fr.univcotedazur.mfc.controllers..*(..))")
